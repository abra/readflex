part of 'dictionary_selection_cubit.dart';

class DictionarySelectionState {
  const DictionarySelectionState({this.selectedIds = const <String>{}});
  ...
  bool operator ==(Object other) =>
      other is DictionarySelectionState &&
