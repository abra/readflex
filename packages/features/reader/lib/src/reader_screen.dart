...
import 'reader_route_mount_gate.dart';
...
const _kReaderTopChromeTitleMaxLines = 2;
const _kReaderTopChromeMinTitleFontSize = 8.0;
const _kReaderTopChromeTitleFontStep = 0.25;
const _kReaderTopChromeTitleLineHeight = 1.30;
const _kReaderWebViewRouteMountDelay = Duration(milliseconds: 300);
