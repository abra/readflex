...
- usage_examples must stay in source_language, use [[...]] around the same selected word/span or larger unit, and return 1-3 concise grammatical complete-sentence examples or [] when none are useful.
...
For selected n-word text, choose selected_expression when the selected span itself is a phrasal verb, idiom, fixed phrase, learner-dictionary collocation, verb pattern, preposition pattern, or sentence pattern. Otherwise choose span_translation. Do not classify ordinary compositional descriptive spans as selected_expression only because their words are adjacent; examples that should be span_translation unless broader context makes them idiomatic: new security review, red leather notebook, old wooden door.
''';
}
