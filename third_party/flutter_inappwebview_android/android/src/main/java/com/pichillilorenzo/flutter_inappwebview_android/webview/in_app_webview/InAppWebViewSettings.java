...
public class InAppWebViewSettings implements ISettings<InAppWebViewInterface> {
  ...
  public Boolean useCustomSelectionHandles = false;
    ...
    for (Map.Entry<String, Object> pair : settings.entrySet()) {
      ...
      switch (key) {
        ...
        case "disableContextMenu":
          ...
          break;
        case "useCustomSelectionHandles":
          useCustomSelectionHandles = (Boolean) value;
          break;
        case "textZoom":
  ...
  public Map<String, Object> toMap() {
    ...
    settings.put("useCustomSelectionHandles", useCustomSelectionHandles);
