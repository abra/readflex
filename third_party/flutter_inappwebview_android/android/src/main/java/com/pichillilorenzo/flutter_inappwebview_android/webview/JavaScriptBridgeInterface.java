...
public class JavaScriptBridgeInterface {
  ...
  @JavascriptInterface
  public void _readerSelectionMagnifier(double x, double y, boolean visible) {
    final InAppWebView view = inAppWebView;
    if (view != null) view.postReaderSelectionMagnifier(x, y, visible);
  }
